...
class CreatePostsPresenter(
    ...
    private val readBackupFile: UseCase.IReadBackupFile,
    private val createBackupFile: UseCase.ICreateBackupFile,
    private val deleteBackupFile: UseCase.IDeleteBackupFile,
